	...
	<div class="col-lg-12">
		...
		<div class="col-lg-12">
			<ul class="breadcrumb">
			    ...
			    <li class="active">เพิ่มรายการพัสดุ</li>
			</ul>
		</div>
		</div>
		<br />
		...
		<div class="col-lg-10 col-lg-offset-1">
			{!! Form::open( array('route' => 'supplier.store', 'class' => 'form-horizontal') ) !!}
				...
				@endif
					...
					<div class="col-lg-10">
						{!! Form::select('type_code', [null=>'กรุณาเลือก'] + $type, null, ['class'=> 'form-control', 'id' => 'type_code_i']) !!}
					</div>
				</div>
				...
				@endif
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" name="sp_code" id="sp_code_i" placeholder="รหัส"/>
					</div>
				</div>
				...
				@endif
					...
					<div class="col-lg-10">
						<input type="text" class="form-control" name="sp_name" placeholder="ชื่อพัสดุ"/>
					</div>
				</div>
				...
				@endif
					...
					<div class="col-lg-10">
						{!! Form::select('id_unit', [null=>'กรุณาเลือก'] + $unit, null, ['class'=> 'form-control']) !!}
					</div>
				</div>
