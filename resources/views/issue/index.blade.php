...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="col-lg-12">
            ...
            @if( $status == 'close' )
                <h2 class="text-danger">ระบบจะปิดการขอเบิกพัสดุทุกวันอังคาร</h2>
            @else
			
			<div class="row">
				<div class="col-lg-12">
							
				<form id="frmissue" name="frmissue" action="addissueTemp" class="form-horizontal boxreceive">
					...
					<div class="form-group">				 		
				 		<div class="col-lg-4">
							...
							<div class="col-lg-10">
								<input id="issue_supplier" name="issue_supplier" class="form-control" type="text" placeholder="รายการ" autocomplete="off">
					...
					<div class="form-group">
					  <div class="center">
						<input type="button" class="btn btn-info btn-sm" id="add-issue-list" value="เพิ่ม" />
					  </div>
					</div>	
						...
						<div id="listissueTemp">
							@if( isset($data) )
								...
								<div class="col-lg-12">
								    ...
								    <div class="right">
									<div class="form-group">
										<a href="#" onclick="clearissueTemp({{ Session::get('uid') }})" class="btn btn-default" >ยกเลิก</a>
